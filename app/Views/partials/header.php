...
<head>
    ...
    <script type="text/javascript" src="<?=base_url()?>js/holiday.js"></script>
</head>
<body>
<?php
// echo view('partials/navbar.php');
echo view('partials/sidebar.php') ?>
<div class="uk-section">
    <div class="db-container uk-width-1-1">
